...
const TopPlayers = () => {
  return (
    <div className="relative w-full bg-white rounded-2xl h-fit-content mx-auto mt-10 p-4 shadow-md">
      <div className="pb-4">
        <table className="w-full font-extralight mb-5">
          <thead>
            <tr>
      ...
      <Link className="absolute bottom-5 right-5 font-extralight" to="/players">View All Players &#x2192;</Link>
    </div>
  );
};
