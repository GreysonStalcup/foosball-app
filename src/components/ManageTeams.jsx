      ...
      <div className="grid h-screen place-items-center bg-gray-100">
        <div className="text-center mx-8 my-8 w-3/4 h-auto bg-white shadow-md rounded-lg p-8">
          ...
          <div className="flex justify-center mb-8">
            <button
              className={`${
                showNewTeamForm ? "bg-purple-200" : "bg-purple-600"
              } transition ease-in-out text-white py-2 px-4 rounded-lg mr-4`}
            ...
            <button
              className={`${
                showRecordScoreForm ? "bg-purple-200" : "bg-purple-600"
              } transition ease-in-out text-white py-2 px-4 rounded-lg`}
          ...
          {showNewTeamForm && (
            <NewTeamForm onSaveTeamData={handleSaveTeamData} />
          )}
